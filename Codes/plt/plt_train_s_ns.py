...
if __name__ == '__main__':
  for file in ['AT', 'human', 'mouse']:
    ...
    # print(y_test)
    # ks(y_predicted1, y_test1, y_predicted2, y_test2, y_predicted3,y_test3,name)
    for mat in ['png', 'pdf', 'eps']:
        ks_2(y_predicted1, y_test1, y_test_no1,y_predicted_no1, name ,'XGBboost',mat)
        ks_2(y_predicted2, y_test2, y_test_no2, y_predicted_no2, name,'SVM',mat)
        ks_2(y_predicted3, y_test3, y_test_no3, y_predicted_no3, name,'RF',mat)
